...
class ResumeApplyFactory extends GlobalFactory
{
    ...
    {
        $query = JobApply::with(['resume','job','applyStatus'])->whereHas('resume',function ($query) {
        ...
        return $this->table
            ...
            ->queryAddColumn('interview_location_label',function ($item) {
                ...
                return "<span>
                        ...
                        <a class='input-location hand'>$location</a>
                </span>";
            })
            ->queryRender();
    }
    ...
    {
        return $this->table
            ->config('resume-apply',trans('control::app.resume_apply'))
            ...
            ->addInputGroup(trans('control::app.interview_location'),'interview_location' ,'interview_location','none','fa fa-map-marker','input-location hand',['data-modal' => '#modal-resume-apply-input-location','readonly'],'',false)
            ...
            ->addViewField(trans('control::app.sender_receiver'),'sender_receiver','sender_receiver','sender_receiver','text-center','','70px')
